...
import { Home, Mail, Code, Cloud, Bot, Users, DollarSign, MoreHorizontal, Lock, Fingerprint, KeyRound, Settings } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { href: '/security', icon: Settings, label: 'Segurança' },
];
