...
import { ForgotPassword } from "@/pages/ForgotPassword"; // Nova página de recuperação de senha
import { ResetPassword } from "@/pages/ResetPassword"; // Nova página para definir nova senha
          ...
          <AuthProvider>
            <MasterPasswordProvider>
              <Routes>
                ...
                <Route path="/auth/forgot-password" element={<ForgotPassword />} /> {/* Nova rota */}
                <Route path="/auth/reset-password" element={<ResetPassword />} /> {/* Nova rota */}
                <Route path="/auth/2fa-verify" element={<TwoFactorVerify isOpen={true} onClose={() => {}} onVerified={() => {}} />} />
